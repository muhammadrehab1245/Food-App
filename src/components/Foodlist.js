...
export const Foodlist = (props) => {
    ...
    const foodname = React.createRef();
    const foodprice = React.createRef();
    const foodtag = React.createRef();
    const foodimg = React.createRef();
    const foodid = React.createRef();
...
const {addorder}=context
    ...
    e.preventDefault()
      addorder(foodname.current.textContent,foodtag.current.textContent,foodprice.current.textContent,foodimg.current.src,foodid.current.textContent)
    };
  return (
    <GridItem>
